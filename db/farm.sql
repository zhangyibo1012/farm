...
CREATE TABLE `banner` (
  ...
  `status` tinyint(1) DEFAULT NULL COMMENT '上下线状态',
  `url` varchar(255) DEFAULT NULL COMMENT '链接地址',
  `create_time` datetime DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '创建时间',
  `update_time` datetime DEFAULT NULL COMMENT '更新时间',
  `sort` int(11) DEFAULT NULL COMMENT '排序',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=6 DEFAULT CHARSET=utf8mb4 COMMENT='广告轮播图';
...
CREATE TABLE `dish` (
  ...
  `describe` varchar(255) DEFAULT NULL COMMENT '菜品描述',
...
CREATE TABLE `farm_shop` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COMMENT='农家店铺表';
